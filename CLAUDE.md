...
> - **Règle de répartition (50/30/20)** : éditable dans Réglages — **curseur** + pourcentage **et** montant côte à côte, tous liés (le montant = revenu cible × %, et inversement). Reste indicative (n'impose pas encore les enveloppes).
